function [X, s, nEval] = stein_fw(nDim, fscr, k, fmin, nIter, fdraw)
% [X, s, nEval] = stein_fw(nDim, fscr, k, fmin, nIter, fdraw) generates
% a sequence of points that approximates the density whose score is given
% by fscr. This is achieved by minimising the KSD using the Frank-Wolfe
% algorithm.
%
% Input:
