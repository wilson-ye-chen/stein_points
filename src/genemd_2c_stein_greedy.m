%%
% File: genemd_2c_stein_greedy.m
% Purpose:
% Generates EMD plots for various KSD greedy algorithms. The target is a
...
[X_3, ~, nEval_3] = stein_greedy(2, fu, k_3, fmin_1, nPart, []);
[X_4, ~, nEval_4] = stein_greedy(2, fu, k_1, fmin_2, nPart, []);
[X_5, ~, nEval_5] = stein_greedy(2, fu, k_2, fmin_2, nPart, []);
[X_6, ~, nEval_6] = stein_greedy(2, fu, k_3, fmin_2, nPart, []);
[X_7, ~, nEval_7] = stein_greedy(2, fu, k_1, fmin_3, nPart, []);
[X_8, ~, nEval_8] = stein_greedy(2, fu, k_2, fmin_3, nPart, []);
[X_9, ~, nEval_9] = stein_greedy(2, fu, k_3, fmin_3, nPart, []);
...
% Print to PDF
name = sprintf('genemd_2c_stein_greedy_%d', nPart);
print(name, '-dpdf');
