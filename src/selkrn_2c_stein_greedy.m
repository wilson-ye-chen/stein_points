%%
% File: selkrn_2c_stein_greedy.m
% Purpose:
% Plots EMD values for KSD greedy algorithms with various kernels. The target
% is a two component Gaussian mixture distribution.
...
for i = 1:nAlpha
    for j = 1:nBeta
        ...
        X_1(:, :, t) = stein_greedy(2, fu, k, fmin, nPart, []);
...
for i = 1:nAlpha
    ...
    X_2(:, :, i) = stein_greedy(2, fu, k, fmin, nPart, []);
    Param_2(i) = alpha(i);
end
...
for i = 1:nAlpha
    for j = 1:nBeta
        ...
        X_3(:, :, t) = stein_greedy(2, fu, k, fmin, nPart, []);
...
% Print to PDF
name = sprintf('selkrn_2c_stein_greedy_%d', nPart);
print(name, '-dpdf');
