...
% Purpose:
% Generate point-set plots from the output file of genemd_igarch.m.
% Date: February 4, 2018
%%

% Load the output file
load('genemd_igarch_100.mat');

% log-posterior density (un-normalised)
...
for i = 1:numel(alg)
    ...
    contour(t1, t2, Z, 'levelstep', 2, 'linewidth', 0.8);
    ...
    % Print to PDF
    name = sprintf('genpts_igarch_%s_%d', lab{i}, nPart);
    print(name, '-dpdf');
end
